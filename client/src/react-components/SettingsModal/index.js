          ...
          <Fade in={this.state.modalOpen}>
            <div className='paper'>
              ...
              <FormGroup>
                ...
                {/* TODO:  */}
                <FormControlLabel
                  control={<BlueSwitch className="considerBase" checked={this.state.considerBase} onChange={this.handleChange("considerBase")} aria-label="considering base switch" />}
                  label={this.state.considerBase ? <FormattedMessage id='settings5' /> : <FormattedMessage id='settings2' />}
                />
